...
|-------|---------------|-------------|
| [cidoc-crm.md](cidoc-crm.md) | `/cidoc-crm` | CIDOC-CRM v7.1.3 ontology reference — classes, properties, CRMgeo/CRMdig extensions, modeling decision guide, anti-patterns |
...
- CIDOC-CRM v7.1.3 specification (ISO 21127)
